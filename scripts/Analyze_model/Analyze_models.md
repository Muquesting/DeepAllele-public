...
van der Veeken, J. et al. Natural genetic variation reveals key features of epigenetic and transcriptional memory in virus-specific CD8 T cells. Immunity 50, 1202-1217.e7 (2019).
use batch_id=sum
To load the data from the paper:
