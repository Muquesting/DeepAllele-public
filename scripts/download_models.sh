...
process_data='https://figshare.com/ndownloader/articles/28694384/versions/5?folder_path=Processed_data'
...
wget -O ${datadir}atac/data/ATAC-seq-preprocessed.hdf5 https://figshare.com/ndownloader/files/53431316
